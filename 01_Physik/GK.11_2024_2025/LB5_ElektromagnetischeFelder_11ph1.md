...
### 1.3. Arbeitsaufträge zum Transformator
...
Video: [Cassy-Tutorial-Video](https://www.youtube.com/watch?v=2gPGb_NdbqM)

__Arbeitsablauf:__

- im oberen Menü des Cassy-Messgerätes zur Spannung U

- klicken Sie auf den Pfeil nach unten um die Einstellungen für die Spannungsmessung zu öffnen

- ![Cassy4](https://diversewolken.ddns.net/nextcloud/index.php/s/GtXbzxYKPSjbkaQ/download)

- damit das Cassy-Messgerät eine Wechselspannung messen kann, muss der Modus aus @color(Effektiv-Werte DC&AC, red) eingestellt werden

- ändern Sie den Wert Parameter __Erfassung__ zu @color(Effektiv-Werte DC&AC, red)

- klicken Sie mehrfach auf den Pfeil nach oben, Sie sollten zur Anzeige der Spannungsmessung zurückkehren
...
Bauen Sie einen Transformator nach folgendem Vorbild auf. Nutzen Sie zwei Cassy-Messgeräte um Primär- und Sekundärspannung für verschiedene Kominationen aus Primär- und Sekundärwindungszahl zu untersuchen.

__Einstellungen:__

Nutzen Sie am Spannungsversorgungsgerät die Einstellung: __Wechselspannung, 6V__.

__Analyse:__ 

Zeichnen Sie einen Graphen mit $n=\dfrac{N_1}{N_2}$ auf der x-Achse und $n'= \dfrac{U_1}{U_2}$ auf der y-Achse.
...
### 1.4. Lenz'sche Regel - Richtung der Induktionsspannung
