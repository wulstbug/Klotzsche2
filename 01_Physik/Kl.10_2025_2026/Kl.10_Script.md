...
> __Beschreibung:__ Ein Fadenpendel ist an einem Strick aufgehängt und ein Hindernis wird mittig installiert, sodass das Fadenpendel auf der einen Seite mit einer verkürzten Fadenlänge schwingt. __[HEMMUNGSPENDEL](https://youtu.be/wMOgfiajqtY)__
...
### Demonstrationsexperiment Erzwungene Schwingung
...
Wir stellen die **zeitliche Bewegung** eines einzelnen Oszillators (d.h. ein schwingendes Teilchen) mit einem **$y$-$t$-Diagramm** und die **räumliche Ausbreitung der Schwingung** mit einem **$y$-$x$-Diagramm**.
************
...
> __$y(x)$-Diagramm__
>
> Für einen **bestimmten Zeitpunkt** wird dargestellt, **welche Lage die Schwinger** zu diesem Zeitpunkt haben:
>
...
> __$y(t)$-Diagramm__
>
> Für einen **bestimmten Ort** wird dargestellt, wie sich der betreffende Schwinger **zeitlich** verhält.
>
...
> **Wellenlänge**
>
> Die Wellenlänge ist der minimale Abstand zwischen zwei Schwingern, die sich im gleichen Schwingungszustand befinden (z.B. Abstand zwischen zwei benachbarten **Wellenbergen** oder **Wellentälern**).  
>
...
> **Frequenz**
>
> Die Frequenz $f$ beschreibt die Anzahl an vollständigen Schwingungen eines Schwingers pro Sekunde.
>
> Es gilt: $f=\frac{1}{T}$
>
> **Formelzeichen:** $f$  
...
>
> Die Ausbreitungsgeschwindigkeit einer Welle ist die Geschwindigkeit, mit der sich eine Welle (__z.B. ein Wellenberg__) im Raum ausbreitet. 
> 
> **Formelzeichen:** $v$  
>
...
> __Wellenausbreitungsgleichung:__:
>
...
__@color(Konstruktive Interferenz - *"Berg auf Berg"*, red)__
...
__@color(Destruktive Interferenz *"Berg auf Tal"*, blue)__
...
[qr-code](https://liascript.github.io/course/?#1)
...
![Ausbreitung](https://diversewolken.ddns.net/nextcloud/index.php/s/As3ib8Q53EJTxZy/download "Dunkle Stellen (hoher Luftdruck), Helle Stellen (niedriger Luftdruck)")
...
## 2. 17. Das menschliche Gehör

> Die heutige Stunde widmet sich der Wahrnehmung von Schallwellen, dem @color(__Hören__, blue).
>
> Folgende Fragen sollen dazu mit verschiedenen Materialien bearbeitet werden.

{{1}}
********
> 1. Wie funktioniert die Wahrnehmung von Schallwellen im menschlichen Ohr.
********

{{2}}
********
> 2. Auf welche Weise werden die Schallwellen in vom Gehirn interpretierbare Reize umgewandelt.
********

{{3}}
********
> 3. Welche Wahrnehmungsgrenzen besitzt das menschliche Gehör bezüglich der Frequenz der Töne und der Lautstärke.
********

{{4}}
********
> 4. Welche Gefahren bestehen für das menschliche Ohr im Alltag, welche Schäden können auftreten.
********

### Material 1: Video _Das Ohr_
...
{{1}}
**********
> Versuchsbeschreibung: Mit einem Frequenzgenerator und einem Lautsprecher werden Töne verschiedener Frequenzen erzeugt.
**********


{{2}}
**********
> Ziel: Bestimmung der Hörschwelle für verschiedene Frequenzen.
**********

{{3}}
**********
> Die elektrische Leistung des __Lautsprechers P__ wird dabei durch die physikalischen Größen __Spannung U__ und __Stromstärke I__ gemessen. P wird Schrittweise erhöht, bis ein Ton hörbar ist. Dann soll Spannung und Stromstärke notiert werden.

---
__Messwerte:__

![Messwerttabelle](https://diversewolken.ddns.net/nextcloud/index.php/s/22e36yMTKB4ntfN/download)
**********
