...
An Orten, wo sich zwei __Wellenberge__ oder zwei __Wellentäler__ überlagern, spricht man von @color(__konstruktiver Interferenz__, red). An Orten, wo sich __Wellental und Wellenberg__ überlagern, spricht man von @color(__destruktiver Interferenz__, blue).
...
## Alle Übungsaufgaben zur Klassenarbeit

__Du kannst diesen QR-Code anklicken oder scannen für alle Aufgaben inklusive der Lösungen.__

[qr-code](https://liascript.github.io/nightly/?#1)
...
![Doppelspalt5](https://diversewolken.ddns.net/nextcloud/s/K2kKxcZNBmYfrBe/download)
...
> $d$ = <input type="number" value="12.5e-6" min="0" max="10" id="d" size="5"> m <br> <br> $a$ = <input type="number" value="0.013" min="0" max="10" id="a" size="5"> m <br> <br> $e$ = <input type="number" value="0.29" min="0" max="10" id="e" size="5">m
...
3. 2. Überprüfen Sie, bis zu welcher Ordnung Maxima überhaupt beobachtet werden können. Nehmen Sie an, dass der Schirm beliebig groß sein kann.
