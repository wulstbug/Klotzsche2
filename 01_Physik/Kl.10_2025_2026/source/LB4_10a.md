...
Ich stecke in einem Zug mit Personenschaden kurz vor Dresden fest.

Bearbeite zunächst die Aufgaben (Thema letzte Stunde):

3. Übung zu den Keppler'schen Gesetzen

4. Übung zur Graviatationskraft

Schau dir anschließend die Theorie zum Aufbau zur Sonne (5.) und die Aufgabe dazu (6.) an.

</H3>

## 1. Tabelle mit Daten der Planeten
...
## 2. Eigenschaften des Sonnensystems zum selbstständigen Erarbeiten
...
## 5. Die Sonne (Aufbau und Funktion)
